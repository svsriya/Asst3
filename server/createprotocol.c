...
void createProtocol (char **, char **, char**, int);
int openrequested (char **, char **, char**);
void sendProtoco();
...
void traverseDir( char ** path, char ** protoc){
...
int openrequested (char ** path, char ** cmd, char ** protoc){
...
void createProtocol (char ** path, char ** cmd, char** projj,  int sockd){
	int pfd;
